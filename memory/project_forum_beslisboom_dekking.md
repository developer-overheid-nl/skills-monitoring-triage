...
Het Forum Standaardisatie heeft een [Beslisboom Open Standaarden](https://www.forumstandaardisatie.nl/beslisboom/beslisboom-open-standaarden) die op situatie routeert (sector, kanaal, gegevenssoort) in plaats van op domein. Aangekaart door een betrokkene bij het Forum Standaardisatie op 2026-08-31 na een quick scan van het MOZa-team.
